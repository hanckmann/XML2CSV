...
public:
    ...
    bool convert(const QFile& sourceCSVFile, const QFile& sourceMTXFile, const QString& csvSeperator, const QString& mtxSeperator, const QList<int>& rawColumns, const QList<int>& ignoreColumns, const QList<int>& dtColumn, const QString& dtFormat, const int& minColumns, const bool& noHeader, const bool& lastLine, const bool& unique);
